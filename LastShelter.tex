...
\begin{itemize}
  ...
  \item Upgrade den Helden mit Wisdom Medaillen bis du keine mehr hast. Benutze alle fähigkeiten einse Helden um möglichst wenig Medaillen übrig zu lassen.
  \item Zerlege den Helden jetzt. Dadurch bekommst du einen Teil der Medaillen zurück.
  \item Wiederhole die letzen drei Schritte bist du die dritte Kiste hast oder alle Medaillen verbraucht sind.
  ...
  \item Während des xxx kannst du die Events für bestimmte Tage auswählen. Nimm "`Helden ausbilden"' dann kannst du am Donnerstag doppelt abkassieren.
\end{itemize}	

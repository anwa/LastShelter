...
Du kannst nach unser Allianz suchen oder auf eine Basis der Allianz klicken [(PaT) anmiwasFarm\#0 (X:951, Y:411)] oder mich per PM anschreiben,
...
zu verhindern. Auch alle nicht genutzten Gebäude sind so verbunden, damit man sie schnell anbinden kann falls man etwas daran machen muss.
...
Du bekommst immer eine Mail auf deine richtige Adresse, welche du dann bestätigen musst.
...
\subsection{Beruf}
Um die Farm aufzubauen und auf Level 15 zu bringen, ist der Beruf Bauer sehr hilfreich. Wenn die Farm fertig ist um regelmäßig geplündert zu werden, solltest du auf Händler wechseln.
Das hat mehrere Gründe.

Händler bekommen 50\% mehr Geld von den Banken. Dies gleicht den Verlust der dadurch entsteht, die Bevölkerung nicht zu versorgen wieder aus.

Händler haben keinen Lagerschutz! (Abbildung~\ref{fig:holz}) Bauern haben einen hohen Lagerschutz von 900k. Und obwohl mehrere Millionen Einheiten in den Lagern sind, 
ist die Ausbeute beim Plündern gering.

\begin{figure}[H]
  \centering
     \includegraphics[width=5cm]{Bilder/IMG_E0038.JPG}
  \caption{Holzlager meiner Händler-Farm}
  \label{fig:holz}
\end{figure}

Vergleiche hierzu die folgenden Abbildungen. In Abbildung~\ref{fig:bauer} siehst du das Ergebnis einer Plünderung als die Farm noch Bauer war. 
Die selbe Farm, selber APC kurze Zeit später, nach Umstellung auf Händler (Abbildung~\ref{fig:haendler}).
\begin{figure}[H]
  \centering
     \includegraphics[width=7cm]{Bilder/IMG_E0041.JPG}
  \caption{Plünderung eines Bauern}
  \label{fig:bauer}
\end{figure}
\begin{figure}[H]
  \centering
     \includegraphics[width=7cm]{Bilder/IMG_E0039.JPG}
  \caption{Plünderung eines Händlers}
  \label{fig:haendler}
\end{figure}
